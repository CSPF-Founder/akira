...
class Navigation extends \Tirreno\Controllers\Admin\Base\Navigation {
    ...
    public function switchApplication(): void {
        $this->response->data = $this->dataController->switchApplication();
    }

    public function createApplication(): void {
        $this->response->data = $this->dataController->createApplication();
    }

    public function renameApplication(): void {
        $this->response->data = $this->dataController->renameApplication();
    }
