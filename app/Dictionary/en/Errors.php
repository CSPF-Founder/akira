...
$baseErrors = [
    ...
    \Tirreno\Utils\ErrorCodes::USER_ADDED_TO_WATCHLIST          => 'User has been successfully added to the watchlist',
    \Tirreno\Utils\ErrorCodes::USER_REMOVED_FROM_WATCHLIST      => 'User has been successfully removed from the watchlist',
    \Tirreno\Utils\ErrorCodes::USER_FRAUD_FLAG_SET              => 'User has been successfully marked as fraud',
    \Tirreno\Utils\ErrorCodes::USER_FRAUD_FLAG_UNSET            => 'User has been successfully marked as not fraud',
    \Tirreno\Utils\ErrorCodes::USER_REVIEWED_FLAG_SET           => 'User has been successfully marked as reviewed',
    \Tirreno\Utils\ErrorCodes::USER_REVIEWED_FLAG_UNSET         => 'User has been successfully marked as not reviewed',
    \Tirreno\Utils\ErrorCodes::USER_DELETION_FAILED             => 'User deletion was unsuccessful.',
    \Tirreno\Utils\ErrorCodes::USER_BLACKLISTING_FAILED         => 'User blacklisting was unsuccessful.',
    \Tirreno\Utils\ErrorCodes::USER_BLACKLISTING_QUEUED         => 'This user and all associated IPs are currently queued for blacklisting.',
    ...
    \Tirreno\Utils\ErrorCodes::REST_API_USER_ALREADY_DELETING   => 'User already scheduled for deletion',
    \Tirreno\Utils\ErrorCodes::REST_API_USER_ADDED_FOR_DELETION => 'User added to deletion queue',
